...
import com.jetbrains.signatureverifier.serialization.fileInfos.Blob
import com.jetbrains.signatureverifier.serialization.fileInfos.DmgFileMetaInfo
    ...
    if (codeSignaturePointer.length > 0) {
      ...
      repeat(numBlobs) {
        ...
        when (blobIndexType.toLong()) {
          MachoConsts.CSSLOT_CODEDIRECTORY.toLong() -> {
