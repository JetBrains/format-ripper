...
class SignatureVerificationParams {
  val _signRootCertStore: InputStream?
  val _timestampRootCertStore: InputStream?

  val BuildChain: Boolean
  val WithRevocationCheck: Boolean
  val OcspResponseTimeout: Duration
  val SignValidationTimeMode: SignatureValidationTimeMode
  var SignatureValidationTime: LocalDateTime?
