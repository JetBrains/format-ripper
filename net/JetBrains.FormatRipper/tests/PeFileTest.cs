...
namespace JetBrains.FormatRipper.Tests
{
  ...
  public sealed class PeFileTest
  {
    ...
    [TestCase("IntelAudioService.exe"                             , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_GUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE                                                                                                                         , CodeOptions.HasCmsSignature | CodeOptions.HasMetadata, "CABDFDBE1E041E2B42301E8DC9A9B8D05E7DCE63D2A773FA971213DE105816E128D7DC73FEB979A688F00332C355577B", "[128:8]", "0;0;[0:D8],[DC:4C],[130:5DAD0]")]
    [TestCase("JetBrains.dotUltimate.2021.3.EAP1D.Checked.web.exe", IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_I386 , IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_GUI, IMAGE_FILE.IMAGE_FILE_RELOCS_STRIPPED | IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_32BIT_MACHINE                                           , CodeOptions.HasCmsSignature                          , "D908B8DB1EF44291479A18163385753CEBB2E7DD256F1DDDA7C79A5E33052872792FEE7564FEFABF4D9D5D133ABF4641", "[1A8:8]", "0;0;[0:168],[16C:3C],[1B0:2279AF0]")]
    [TestCase("ServiceModelRegUI.dll"                             , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "F25E3A0B4B930208C6524CE6F9E762BFE99C8657A0A0796144A93C003C94C8032EA50CF215043588A35BF12AB47F1DCA", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    [TestCase("ServiceModelRegUI_broken_counter_sign.dll"         , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "F84C34B0F4D2B5201D53EF92B4A437256B1D5130CA9A7C3A035DE1FEB23CC4DC5B461ED8AD82DDA15CA7DDE025DB37B3", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    [TestCase("ServiceModelRegUI_broken_hash.dll"                 , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "9A265A0C8B9955A18B4BCF6795B85F54DBDD0510BB0D9B336B33679C0C44B167154702A649B63E50198AA4507EA991BA", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    [TestCase("ServiceModelRegUI_broken_nested_sign.dll"          , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "51213207ED1B0DC09F70B9879D42D269C83068E362D7B9855F71450C49B1CAAE321DA8773FFC738DCDA2FC35C67F1B48", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    [TestCase("ServiceModelRegUI_broken_nested_sign_timestamp.dll", IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "5BFAB068C6A7298B2947EE17914FB9FC6D849C78BD442B9E9CB56E04490F5FD647A58E0DEADDE3E68FE7F1068C4BC9BE", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    [TestCase("ServiceModelRegUI_broken_sign.dll"                 , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "23D9D4D67504B25A67D897743A4CFCC6DD7B810A12E50F0D834E3FBC05BB03FF92C78EF1536F53345E9DB87B6BF18857", "[150:8]", "0;0;[0:100],[104:4C],[158:8A8]")]
    ...
    [TestCase("System.Security.Principal.Windows.dll"             , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_I386 , IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature | CodeOptions.HasMetadata, "81E2CE2291B5BDF0724639FA17360E4C707EF513FE15ED032A35742F910BA54CF76EA74BDE0B304A6839427DFD018A0C", "[118:8]", "0;0;[0:D8],[DC:3C],[120:16E0]")]
    [TestCase("api-ms-win-core-rtlsupport-l1-1-0.dll"             , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_I386 , IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_32BIT_MACHINE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                                   , CodeOptions.HasCmsSignature                          , "F9EE34D26BDD204A45D80A43382C4B241E9A166F84670E6625761B44012CED0904D351676D2BB08849EE24F5592B41E5", "[150:8]", "0;0;[0:110],[114:3C],[158:6A8]")]
    [TestCase("dotnet.exe"                                        , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_CUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE                                                                                                                         , CodeOptions.HasCmsSignature                          , "5270038904B10DC31E236C424C863FA35F4B7822D826774C759E69EA05C1EA167F8CC56A2B6EE214DEF5774CB4B54569", "[1A8:8]", "0;0;[0:158],[15C:4C],[1B0:1B050]")]
    [TestCase("libcrypto-1_1-x64.dll"                             , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_GUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "4E6C2E9F3EC563CC8580BD5ABFB8AFFB160E079260E0A3C3776146FBBC34C2EA3A51C19CC5B7F60888C69FC99122C749", "[1A0:8]", "0;0;[0:150],[154:4C],[1A8:299058]")]
    [TestCase("libssl-1_1-x64.dll"                                , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_GUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "7BF27779F75B36FB25542EB7E8269CCDA7B592485457ECD236CB12323DC1EFA0B4106772C30FE43FDF5091DF1D9C761E", "[1A0:8]", "0;0;[0:150],[154:4C],[1A8:A0258]")]
    [TestCase("shell32.dll"                                       , IMAGE_FILE_MACHINE.IMAGE_FILE_MACHINE_AMD64, IMAGE_SUBSYSTEM.IMAGE_SUBSYSTEM_WINDOWS_GUI, IMAGE_FILE.IMAGE_FILE_EXECUTABLE_IMAGE | IMAGE_FILE.IMAGE_FILE_LARGE_ADDRESS_AWARE | IMAGE_FILE.IMAGE_FILE_DLL                                                                                             , CodeOptions.HasCmsSignature                          , "DE053E2A73D93500D8AAA51DD6DF217C48CBA4BBDB8D3420F4A326C601A02D761C656C48B6130FBC9715BDA8EF6A76C3", "[1A8:8]", "0;0;[0:158],[15C:4C],[1B0:735650]")]
    ...
    public void Test(
      ...
      string? expectedCmsSignatureBlobHash,
      string expectedSecurityDataDirectoryRange,
      string expectedIncludeRanges)
    {
      var file = ResourceUtil.OpenRead("Pe." + filename, stream =>
        {
          Assert.IsTrue(PeFile.Is(stream));
          return PeFile.Parse(stream, PeFile.Mode.ReadCodeSignature);
        });
      ...
      var hasCmsSignature = (expectedOptions & CodeOptions.HasCmsSignature) == CodeOptions.HasCmsSignature;
      ...
      Assert.AreEqual(hasCmsSignature, file.CmsSignatureBlob != null);

      if (file.CmsSignatureBlob != null)
      {
        byte[] hash;
        using (var hashAlgorithm = SHA384.Create())
          hash = hashAlgorithm.ComputeHash(file.CmsSignatureBlob);
      ...
      ValidateUtil.Validate(file.ComputeHashInfo);
