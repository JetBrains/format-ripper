...
namespace JetBrains.FormatRipper.Elf.Impl
{
  ...
  internal struct Elf32_Ehdr
  {
    ...
    internal UInt32 e_entry; /* Entry point virtual address */
    internal UInt32 e_phoff; /* Program header table file offset */
    internal UInt32 e_shoff; /* Section header table file offset */
