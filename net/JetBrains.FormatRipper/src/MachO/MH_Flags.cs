...
namespace JetBrains.FormatRipper.MachO
{
  ...
  public enum MH_Flags : uint
  {
    ...
    MH_APP_EXTENSION_SAFE            =  0x2000000, /* The code was linked for use in an application extension. */
    MH_NLIST_OUTOFSYNC_WITH_DYLDINFO =  0x4000000, /* The external symbols listed in the nlist symbol table do not include all the symbols listed in the dyld info. */
    MH_SIM_SUPPORT                   =  0x8000000, /* Allow LC_MIN_VERSION_MACOS and LC_BUILD_VERSION load commands with the platforms macOS, macCatalyst, iOSSimulator, tvOSSimulator and watchOSSimulator. */
