...
namespace JetBrains.SignatureVerifier.Tests.Authenticode
{
  public class SpcIndirectDataContent : Asn1Encodable
  {
    private readonly SpcAttributeOptional data;
    private readonly DigestInfo messageDigest;
    ...
    {
      return new BerSequence(new Asn1EncodableVector(data, messageDigest));
    }
  }
