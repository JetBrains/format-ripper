...
namespace JetBrains.SignatureVerifier.Crypt
{
    public static class OIDs
    {
        ...
        public static readonly DerObjectIdentifier APPLE_CERTIFICATE_EXTENSION_CODE_SIGNING = new("1.2.840.113635.100.6.1.13");
        public static readonly DerObjectIdentifier APPLE_CERTIFICATE_EXTENSION_KEXT_SIGNING = new("1.2.840.113635.100.6.1.18");
