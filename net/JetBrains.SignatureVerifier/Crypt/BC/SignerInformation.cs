		...
		*/
        public IReadOnlyCollection<SignerInformation> GetCounterSignatures()
        {
            ...
            */
                ...
                */
                ...
                foreach (Asn1Encodable asn1Obj in values)
                {
                    ...
                    */
                    ...
                    string digestName = Helper.GetDigestAlgName(si.DigestAlgorithm.Algorithm.Id);
            ...
            return counterSignatures.AsReadOnly();
        }
            ...
            AsymmetricKeyParameter key)
        {
            ...
            if (sigAlgOid.Equals(PkcsObjectIdentifiers.IdRsassaPss))
            {
                ...
                try
                {
                    ...
                    {
                        sig = PssSigner.CreateRawSigner(rsa, pssDigest, pssDigest, saltLength,
...
//					throw new CmsException("unrecognised signature parameters provided");
            ...
            byte[] signature)
        {
            ...
            try
            {
                ...
                {
                    IBufferedCipher c = Helper.CreateAsymmetricCipher("RSA/ECB/PKCS1Padding");
